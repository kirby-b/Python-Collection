def main():
    print("This program will create a .py file with basic setup, if you want it to be in a different location you "
          +
          "should add it before the name. Dont give it a file extension")
