...
def main():
    ...
    while(True):
        try:
            choice = str.lower(str.strip(input("Do you want a Coin (two sides) or Dice (you get to pick number of sides). Input Coin, Dice, C, or D:")))
            while True:
                if validate(choice):
                    break
                else:
                    choice = str.lower(str.strip(input("Invalid Input. Do you want a Coin (two sides) or Dice (you get to pick number of sides). Input Coin, Dice, C, or D:")))
